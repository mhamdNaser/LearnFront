...
export default function HomeGeneralExam() {
  return (
    <div className="homeexam-container pt-5 pb-5">
      <div className="homeexam-header">
        <h2 className="text-dark">You have chosen the General Training test.</h2>
        <Link to={'/generalpage'}>Select a different test</Link>
      </div>
      <div className="homeexam p-0 bg-white">
        <div className="d-flex">
          <img src="/image/keyboard1.jpg" alt="" />
          <div className="px-4">
            <h2 className="mt-5 text-dark">How do the familiarisation tests work?</h2>
            ...
            partners, GEL IELTS.
            <br /><br />
            <Link className="btn btn-primary mb-4" to={'/generalfullexam'}>Start Test</Link>
          </div>
        </div>
      </div>
    </div>
