...
export default function Profile() {
    ...
    const data = {
        labels: arrayFromJson.map(ele => { return ('Form: ' + ele.formExam.id + ' - ' + ele.formExam.type) }),
        datasets: [
            {
                label: 'Student Result' ,
                data: arrayFromJson.map(ele => { return (ele.result) }),
    ...
    const getUserResult = () => {
        axiosClient.get(`/userscoreExam/${user.id}`).then((response) => {
        ...
        <div className='container'>
            <div className='d-flex my-5 justify-content-center gap-2'>
                ...
                <div className='col-lg-8 border d-flex align-items-center ps-4'>
                    ...
                    <div className='px-1'>
                        <h6 className='text-secondary'>{' '}{useData.first_name}{' '}{useData.last_name}</h6>
